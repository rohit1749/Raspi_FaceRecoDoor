...
id = 0
font = cv2.FONT_HERSHEY_COMPLEX       # overlay for showing name of the person
height=1
...
recognizer.read('trainer/trainer.yml') # read the trained data
# names related to id
names = ['Unknown', 'Rohit', 'Rahul', 'Ram']#id denotes user no.
...
cam.preview_configuration.controls.FrameRate=20
...
while True:
    ...
    print("\n door locked") # by default door is locked
    GPIO.output(3,False)
    ...
    for(x,y,w,h) in faces:
        ...
        if confidence < 100:
            id = names[id] #id is converted to string
